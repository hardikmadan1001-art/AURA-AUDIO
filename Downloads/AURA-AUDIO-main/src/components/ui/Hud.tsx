...
export default function Hud() {
  ...
  return (
    <>
      ...
      {/* Music button — opens GTA-style radial wheel */}
      <button
        onClick={openWheel}
        data-hover
        className="fixed right-6 top-6 z-40 rounded-full border border-white/30 px-4 py-2 text-[11px] uppercase tracking-[0.35em] text-white/80 backdrop-blur-sm transition-all hover:border-[#57e6ff] hover:text-[#57e6ff] md:right-10 md:top-10"
        style={{ animation: 'musicBtnFloat 3s ease-in-out infinite' }}
      >
        Music
      </button>
